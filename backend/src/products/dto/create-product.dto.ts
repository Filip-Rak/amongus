...
{
	@Transform( trimString ) @IsString() @MinLength( 1 ) @MaxLength( 150 ) name: string;
	...
	@Transform( trimString ) @IsString() @MinLength( 1 ) @MaxLength( 5000 ) description: string;

	@ValidateNested() @Type( () => ProductPriceDto ) price: ProductPriceDto;
